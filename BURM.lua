...
KeyFrame.Size = UDim2.new(0.9, 0, 0.4, 0)
KeyFrame.Position = UDim2.new(0.05, 0, 0.3, 0)
KeyFrame.BackgroundColor3 = Color3.fromRGB(20, 20, 50)
...
KeyBox.BackgroundColor3 = Color3.fromRGB(10, 10, 40)
...
UnlockBtn.Size = UDim2.new(0.6, 0, 0.25, 0)
UnlockBtn.Position = UDim2.new(0.2, 0, 0.65, 0)
...
-- ====================================================
-- 3. КНОПКИ МЕНЮ (появляются после разблокировки)
-- ====================================================
local BtnContainer = Instance.new("ScrollingFrame")
BtnContainer.Size = UDim2.new(1, -20, 1, -0.15)
BtnContainer.Position = UDim2.new(0, 10, 0.12, 0)
...
CreatorLabel.Position = UDim2.new(0, 0, 0.92, 0)
...
-- ====================================================
-- 4. ФУНКЦИЯ ПОКАЗА МЕНЮ (кнопка в углу)
-- ====================================================
...
UnlockBtn.MouseButton1Click:Connect(function()
    ...
    if input == "67" then
        ...
        greet.Size = UDim2.new(0.8, 0, 0.08, 0)
        greet.Position = UDim2.new(0.1, 0, 0.02, 0)
        ...
        -- Анимация приветствия (исчезает через 3 сек)
        TweenService:Create(greet, TweenInfo.new(3, Enum.EasingStyle.Linear), {
            TextTransparency = 1
        }):Play()
        
        game:GetService("Debris"):AddItem(greet, 4)
        
        ErrorLabel.Text = ""
    else
        ErrorLabel.Text = "❌ ключ не тот (подсказка долго вечный мем)"
        ErrorLabel.TextColor3 = Color3.fromRGB(255, 50, 50)
        KeyBox.Text = ""
    end
end)
...
function ToggleFly()
    if flyEnabled then
        ...
        -- Управление через виртуальные кнопки (на телефоне автоматически)
        RunService.Heartbeat:Connect(function()
