-- ============================================
-- ⚠️ ТЮРЬМА 4.0 (ПОЛНАЯ ВЕРСИЯ)
-- ТОЛЬКО ДЛЯ ВАШЕГО ПЕРСОНАЖА!
-- ============================================
...
-- Кнопка 4: Проигнорить (НОВАЯ!)
local IgnoreBtn = Instance.new("TextButton")
IgnoreBtn.Size = UDim2.new(0.3, -5, 0, 45)
IgnoreBtn.Position = UDim2.new(0.35, 0, 0.85, 0)
...
local function ignoreFunction()
    ...
    ignoreFrame.Size = UDim2.new(0, 300, 0, 200)
    ignoreFrame.Position = UDim2.new(0.5, -150, 0.5, -100)
    ignoreFrame.BackgroundColor3 = Color3.fromRGB(30, 20, 40)
    ignoreFrame.BackgroundTransparency = 0.1
    ...
    ignoreText.Size = UDim2.new(1, -20, 0, 60)
    ignoreText.Position = UDim2.new(0, 10, 0, 20)
    ...
    -- Кнопка "ОТВЕТИТЬ" - тюрьма на 15 секунд
