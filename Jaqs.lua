...
-- 2. SPEED
local speedBtn = createButton("💨 SPEED", 70, Color3.fromRGB(200, 150, 0), function()
...
-- 3. KOKOS DANCE
local kokosBtn = createButton("🥥 KOKOS DANCE", 140, Color3.fromRGB(200, 50, 200), function()
    KokosDance()
end)

-- 4. INFINITE JUMP
local jumpBtn = createButton("🔄 INFINITE JUMP", 210, Color3.fromRGB(0, 150, 150), function()
...
-- 5. ESP
local espBtn = createButton("👁️ ESP", 280, Color3.fromRGB(0, 200, 0), function()
    ShowPlayerSelect()
end)
...
HideBtn.Position = UDim2.new(0.7, 0, 0.92, 0)
...
CreatorLabel.Position = UDim2.new(0.05, 0, 0.92, 0)
...
print("📱 Все 5 кнопок должны отображаться!")
